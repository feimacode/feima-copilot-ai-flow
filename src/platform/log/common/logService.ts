...
/**
 * No-op log service for use in unit tests.
 * All methods are silent. Satisfies ILogService without VS Code API calls.
 */
export class NullLogService implements ILogService {
	...
	createSubLogger(_topic: string | readonly string[]): ILogService {
		return this;
	}

	withExtraTarget(_target: ILogTarget): ILogService {
		return this;
	}
}
