...
/**
 * Context information for a flow discussion
 */
...
/**
 * Builds context information for flow discussions using VS Code public APIs
 */
export class FlowContextBuilder {
	/**
	 * Build comprehensive context from the current VS Code state
	 */
	buildContext(request: vscode.ChatRequest): IFlowContext {
		return {
