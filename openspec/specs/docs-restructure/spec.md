...
## Purpose
Reorganize documentation to separate engine-internal docs from user-facing content, and ensure all P1 flows are self-documenting via standardized sharedContext.
