...
Defines the automated release and publish pipeline for `feima-copilot-ai-flow` — tag-triggered CI that produces VSIX packages, generates checksums, validates output, and supports both GitHub Releases and VS Code Marketplace publication.
