# gallery-preview-depth Specification

## Purpose
Provide an enlarged, interactive preview overlay for flow cards with magnifier toggle, role prompt cards, action buttons, and a More menu for additional actions.
