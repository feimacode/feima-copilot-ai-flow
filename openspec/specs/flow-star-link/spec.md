# flow-star-link Specification

## Purpose
Display aggregate star counts from catalog index on flow cards, with a star button that opens the source GitHub repository or gist for starring.
